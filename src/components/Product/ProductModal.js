      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-lg w-full p-6">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 md:pl-6">
            <h2 className="text-2xl font-semibold dark:text-white text-gray-900 mb-4">{title}</h2>
            ...
            <button
              className="mt-4 w-full flex items-center justify-center rounded-lg py-2 px-4 bg-blue-600 text-white text-sm font-medium shadow-md transition-colors duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
